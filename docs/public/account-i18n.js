(function () {
  ...
  const text = {
    ...
    "Scorpio Intelligence 用户中心：账号登录、授权激活、客户端下载与桌面端数据同步入口。": "Scorpio Intelligence account: sign in, activate a license, download Windows and Android clients, and sync research data.",
    ...
    "管理网站账号、设备授权、客户端下载和桌面端数据同步。": "Manage your website account, device license, client downloads, and research-data sync.",
    "下一步": "NEXT STEP",
    ...
    "登录后可同时获取 Windows 桌面端与 Android 移动端。": "Sign in to download both the Windows desktop app and Android mobile app.",
    "桌面版本": "Desktop edition",
    "Personal Pro（默认）": "Personal Pro (default)",
    "默认提供 Pro 完整研究版本，也可切换 Standard 标准版本。": "Pro is selected by default; you can switch to the Standard edition.",
    "下载 Windows Pro": "Download Windows Pro",
    "下载 Windows Standard": "Download Windows Standard",
    "即将提供": "Coming soon",
    "APK 上传并发布后，这里会自动开放下载。": "Download will open automatically after the APK is uploaded and published.",
